...
# letter asset
@export var letter_image: Texture2D
var image_overlay: CanvasLayer
...
func on_interact():
	...
	# Find the image overlay in the scene
	image_overlay = get_tree().root.find_child("ImageOverlay", true, false)
